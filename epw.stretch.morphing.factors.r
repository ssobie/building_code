...
alpha.2020s.file <- paste0('alpha_',var.name,'_',gcm,'_1998-2014_2011-2040.nc')
...
alpha.2050s.file <- paste0('alpha_',var.name,'_',gcm,'_1998-2014_2041-2070.nc')
create_factor_file(gcm.nc,var.name,var.units,
                   alpha.2050s,
                   tmp.dir,alpha.2050s.file)
file.copy(from=paste0(tmp.dir,alpha.2050s.file),to=epw.dir,overwrite=TRUE)

alpha.2080s.file <- paste0('alpha_',var.name,'_',gcm,'_1998-2014_2071-2100.nc')
create_factor_file(gcm.nc,var.name,var.units,
                   alpha.2080s,

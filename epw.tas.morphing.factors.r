...
tmp.dir <- paste0(tmpdir,'/epw_tas_morph_',gcm,'/')
...
for (interval in intervals) {
  ...
  deltx.file <- paste0('delta_tasmax_',gcm,'_1998-2014_',interval,'.nc')
  ...
  deltn.file <- paste0('delta_tasmin_',gcm,'_1998-2014_',interval,'.nc')
  ...
  delts.file <- paste0('delta_tas_',gcm,'_1998-2014_',interval,'.nc')
  ...
  alpha.file <- paste0('alpha_tasmax_tasmin_',gcm,'_1998-2014_',interval,'.nc')
...
tmp.files <- list.files(path=tmp.dir,recursive=TRUE)

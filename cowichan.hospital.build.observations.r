...
bc.si.versions <-  c(NA, ##'degC'), ##Cold Month Design Temperature 5.0% degC,
                     ...
                     2980, ##'DD'), ##Degree Days below 18 degC
                     ...
                     103,   ##'mm'), ##50-Year return period Daily Precipitation
                     NA,  ##'Pa'),  ##5-Year return period Wind Load
                     300,  ##'Pa'))  ##10-Year return period Wind Load
                     390,  ##'Pa'),  ##50-Year return period Wind Load
                     NA,   ##'kPa'), ##20-Year Return Period Snow Load kPa
                     1.8)  ##,'kPa')) ##50-Year Return Period Snow Load kPa
